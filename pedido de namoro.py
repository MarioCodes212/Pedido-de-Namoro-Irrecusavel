...
window = pyglet.window.Window(width=640, height=640, caption='Romance ou só um Lance?')
window.set_location(350, 120)

background = pyglet.shapes.Rectangle(
    0, 0, 640, 640, color=(106, 90, 205))

question = pyglet.text.Label('Quer namorar comigo Japa?',
                             font_name='Arial',
                             font_size=33,
                             x=100, y=520,
                             italic=True,)
...
yesbutton = [pyglet.shapes.Rectangle(100, 380, 100, 50, color=(255, 60, 80, 255), batch=yes),
             pyglet.shapes.Circle(100, 405, 25, color=(
                 255, 60, 80, 255), batch=yes),
             pyglet.shapes.Circle(200, 405, 25, color=(
                 255, 60, 80, 255), batch=yes),
             pyglet.text.Label('Sim', font_name='Arial',
                               font_size=20, x=125, y=393, batch=yes)
             ]

# Botão Não
no = pyglet.graphics.Batch()
nobutton = [pyglet.shapes.Rectangle(120, 400, 100, 50, color=(255, 60, 80, 255), batch=no),
            pyglet.shapes.Circle(120, 425, 25, color=(
                255, 60, 80, 255), batch=no),
            pyglet.shapes.Circle(220, 425, 25, color=(
                255, 60, 80, 255), batch=no),
            pyglet.text.Label('Não', font_name='Arial',
                              font_size=20, x=145, y=413, batch=no)
            ]
